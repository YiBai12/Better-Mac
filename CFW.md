...
## 1.1 使用 Homebrew 安装 aria2

```
brew install clash-for-windows
```

## 1.2 汉化

下载汉化包：https://github.com/BoyceLig/Clash_Chinese_Patch/releases

解压压缩包后，替换`/Applications/Clash for Windows.app/Contents/Resources/app.asar`中的 app.asar 文件

## 二、配置某个程序走不走代理

1. 现在“活动监视器“里找到你想要的进程，记下 PID
2. 打开终端，输入`lsof -p (对应的PID)`
3. 看第一列的 COMMAND，记下来
4. 打开 Profiles，右键 Edit，在 rules 里加入
    ```
    rules:
    - PROCESS-NAME,(对应COMMAND),DIRECT
    ```
